...
* [기술 분석](role/02-skills.md) - 주요 기술, 프레임워크, 플랫폼
* [책임](role/03-responsibilities.md) - 직무 책임
* [활용 사례](role/04-use-cases.md) - 기업들이 AI를 활용하여 구축하는 실제 사례

## 학습 경로
* [학습 경로](../learning-path) - 무엇을 어떤 순서로 학습할 것인가?

# Playbook (평상 시 활용하는 것들 모음)
## Agents.md
